...
import 'package:dailydevotion/admin/settings/video_setting_page.dart';
...
class SettingsPage extends StatefulWidget {
  ...
  const SettingsPage({super.key, required this.user, required this.tr});
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CustomTile(
                          ...
                          //   color: Colors.yellow,
                          // ),
                          leadingText: "📹 ${widget.tr.devotionsManagement}",
                          ontap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) =>
                                    VideoSettingsPage(tr: widget.tr),
                              ),
                            );
                          },
                        ),
